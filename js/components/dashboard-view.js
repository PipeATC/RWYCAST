...
function Dashboard({user,users,atfm}){
  ...
  // El bloque FR24 (movimientos/pistas/FID) era simulado → eliminado. El tablero
  // muestra solo datos reales (ATFM + roster); lo que no hay, se marca "sin datos".
      ...
      h('div',{className:'dash-note'},
        d.atfm.live
          ? ('Demanda, capacidad y regulaciones provienen del módulo ATFM'
             ...
             +'dependencia. No se muestran datos simulados: lo que el feed no entrega aparece como “sin datos”.')
          : ('Sin datos ATFM para esta fecha. Presiona “ACTUALIZAR” para traer la demanda desde Power BI. '
             +'La dotación, turnos y fatiga provienen del roster de la dependencia.'))),
